...
/* harmony import */ var _api_stream__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../api/stream */ "./resources/js/api/stream.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _api_stream__WEBPACK_IMPORTED_MODULE_3__["default"].getAllStreams(_this2.user_id);

              case 2:
                response = _context2.sent;
                _this2.streams = response.data.stream;
                _this2.streamCount = response.data.count;
    ...
    formatDate: function formatDate(date) {
      return moment__WEBPACK_IMPORTED_MODULE_4___default()(date).format('dddd, DD MMMM YYYY hh:mm A');
    },
    countVideos: function countVideos() {
      var _this3 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return _api_video__WEBPACK_IMPORTED_MODULE_2__["default"].getAllVideos(_this3.user_id);

              case 2:
                response = _context3.sent;
                _this3.videoCount = response.data.count;
    ...
    _c("div", { staticClass: "row" }, [
      ...
      _c("div", { staticClass: "col-4 mt-3" }, [
        _c("div", { staticClass: "info-box" }, [
          ...
          _c("div", { staticClass: "info-box-content" }, [
            _c("span", { staticClass: "info-box-text" }, [
              _vm._v("Upcoming Stream")
            ]),
            _vm._v(" "),
            _c("span", { staticClass: "info-box-number" }, [
              _vm._v(_vm._s(_vm.streamCount))
            ])
          ])
        ])
      ])
        ...
        _vm.streams.length > 0
              ...
              _c(
                ...
                _vm._l(_vm.streams, function(stream, key) {
                  return _c("tr", { key: key }, [
                      ...
                      _c(
                        ...
                        [
                          _c("img", {
                            ...
                            attrs: {
                              src:
                                "/images/uploaded-images/" + stream.thumbnail,
                              alt: "..."
                            }
                          })
                        ]
                    ...
                    _vm._v(" "),
                    _c("td", [
                      _vm._v(_vm._s(_vm.formatDate(stream.stream_date)))
                    ])
                  ])
                }),
                0
          ...
          : _c("div", [
              _c(
                ...
                [_vm._v("You have no streaming schedule yet.")]
              )
            ])
      ]),
      _vm._v(" "),
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "card-header" }, [
      _c("h3", { staticClass: "card-title" }, [_vm._v("Upcoming Stream")])
    ])
  },
  function() {
    var _vm = this
